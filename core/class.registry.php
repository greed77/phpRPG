...
class phpRPGRegistry
{
	 ...
	 * @return void
	 */
	public function storeObject( $object, $key, $core = false )
	{
		require_once( APP_PATH .  ( $core ? "core/" : "" ) . 'objects/class.' . $object . '.php');
	...
	/**
	 * a pretty little dump function
	 * @param Mixed $item the info to display
	 * @param Boolean $die kill script after display
	 * @return void
	 */
